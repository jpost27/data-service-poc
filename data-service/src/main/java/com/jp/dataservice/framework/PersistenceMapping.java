...
public class PersistenceMapping {
    ...
    private static final String DTO_PACKAGE = "com.jp.dataservice.model.dto";
    private static final String REPO_PACKAGE = "com.jp.dataservice.repository";
    ...
    public PersistenceMapping(@Autowired List<JPRepository> repositories) {
        ...
        repositories.forEach(repository -> {
            // "com.jp.dataservice.repository.TeamRepository"
            ...
            if (repositoryName != null) {
                ...
                EntityPathBase<?> qClassRoot = Arrays.stream(qClass.getDeclaredFields())
                        ...
                        .findFirst()
                        .orElseThrow();
                EntityMetadata entityMetadata = createEntityMetadata(
                        queryName, dtoName, dtoClass, entityName, entityClass, qClass, qClassRoot, repository);
        ...
        Set<Class<? extends Annotation>> relationshipAnnotations =
                Set.of(OneToOne.class, OneToMany.class, ManyToMany.class, ManyToOne.class);
                ...
                for (Class<? extends Annotation> relationshipAnnotation : relationshipAnnotations) {
                    if (field.isAnnotationPresent(relationshipAnnotation)) {
                        ...
                        EntityConnection connection = new EntityConnection(
                                entityClass, field.getName(), getInnerType(field), relationshipAnnotation);
    ...
    public String dtoFieldNameToEntityFieldName(String fieldName) {
        return ENTITY_CLASS_PREFIX.toLowerCase() + Character.toUpperCase(fieldName.charAt(0)) + fieldName.substring(1);
    }
